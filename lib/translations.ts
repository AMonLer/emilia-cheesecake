...
export const translations: Record<Locale, Translations> = {
  de: {
    ...
    products: {
      ...
      pistachio: 'Köstlicher Pistazienkäsekuchen, cremig und mit einem einzigartigen, unwiderstehlichen Geschmack...',
  ...
  en: {
    ...
    products: {
      ...
      pistachio: 'Delicious pistachio cheesecake, creamy with a unique, irresistible flavour...',
